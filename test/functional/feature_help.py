...
"""Verify that starting blackcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blackcoin with -h for help text")
        ...
        self.log.info("Start blackcoin with -version for version information")
        ...
        self.log.info("Start blackcoind with -fakearg to make sure it does not start")
