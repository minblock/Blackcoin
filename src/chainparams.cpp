...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now mirroring fuckoshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585994761, 2079761, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x9b160556ec1522f7aaf9c7236692df30572bc892b5ee681a2b935a2d2023e9e7"));
        assert(genesis.hashMerkleRoot == uint256S("0x6fb37f1ec9550857c9000b2f5aa89347986cd33ea5a26c475463d85b5b395ac3"));
        ...
        vSeeds.emplace_back("seed-a.blackcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.blackcointools.com");
        vSeeds.emplace_back("dnsseed.blackcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 669587, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2738d0a5eefd29bcdb9e83bf48d981689e03d4f43a9c9c776de71a6a1c336ab5"));
        assert(genesis.hashMerkleRoot == uint256S("0x6fb37f1ec9550857c9000b2f5aa89347986cd33ea5a26c475463d85b5b395ac3"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.blackcointools.com");
        vSeeds.emplace_back("seed-b.blackcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc5485c29216763f08cb2250e8c051c0116d2b2730465d45c310055059aa07278"));
        assert(genesis.hashMerkleRoot == uint256S("0x6fb37f1ec9550857c9000b2f5aa89347986cd33ea5a26c475463d85b5b395ac3"));
